                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className='flex gap-2'>
                              {lecture.isPreviewFree && lecture.lectureUrl && (
                                <p
                                  onClick={() => setPlayerData({ url: lecture.lectureUrl, title: lecture.lectureTitle })}
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-4xl text-2xl font-semibold">{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100)}</p>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Course progress details and updates</li>
              </ul>
            </div>
          </div>
        </div>
